...
public enum ErrorCode {
	...
	AUTH_DUPLICATE_EMAIL("1006", HttpStatus.BAD_REQUEST, "이미 사용 중인 이메일입니다."),
	AUTH_DUPLICATE_NICKNAME("1007", HttpStatus.BAD_REQUEST, "이미 사용 중인 닉네임입니다."),
	AUTH_EMAIL_SEND_LIMIT("1008", HttpStatus.BAD_REQUEST, "이메일 인증 요청 횟수를 초과했습니다. 잠시 후 다시 시도해 주세요."),
	AUTH_EMAIL_SEND_FAILED("1009", HttpStatus.BAD_REQUEST, "인증 메일 발송에 실패했습니다. 이메일 주소를 확인하거나 잠시 후 다시 시도해 주세요."),
	AUTH_CODE_MISMATCH("1010", HttpStatus.BAD_REQUEST, "인증 코드가 일치하지 않습니다."),
	AUTH_CODE_EXPIRED("1011", HttpStatus.BAD_REQUEST, "인증 코드가 만료되었습니다. 인증 요청을 다시 해주세요."),
	AUTH_UNAUTHORIZED("1012", HttpStatus.UNAUTHORIZED, "이메일 또는 비밀번호가 일치하지 않습니다."),
	AUTH_TOKEN_MISSING("1013", HttpStatus.BAD_REQUEST, "인증 정보(토큰)가 누락되었습니다."),
	AUTH_TOKEN_INVALID("1014", HttpStatus.BAD_REQUEST, "유효하지 않은 토큰입니다. 다시 로그인해 주세요."),
	AUTH_ACCESS_TOKEN_CREATE_FAILED("1015", HttpStatus.BAD_REQUEST, "새로운 액세스 토큰 발급에 실패했습니다. 서버 오류가 발생했습니다."),
	AUTH_ACCESS_DENIED("1016", HttpStatus.BAD_REQUEST, "접근 권한이 없습니다."),
	...
	PRODUCT_ALREADY_BOOKMARKED("1201", HttpStatus.BAD_REQUEST, "이미 찜한 상품입니다."),
	...
	PRODUCT_INVALID_PRODUCT("1205", HttpStatus.BAD_REQUEST, "이름, 설명, 카테고리, 상품 이미지는 필수 항목 입니다."),
